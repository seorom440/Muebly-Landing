...
import { getPostBySlug, getAllSlugs, getAllPosts, Language } from "@/lib/blog";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://muebly.app/blog/${post.slug}` },
    openGraph: {
      title: post.title,
      description: post.description,
      ...
      <main className="pt-28 pb-20">
        ...
        {related.length > 0 && (
          <div className="container mx-auto px-6 max-w-6xl mt-20">
            <h2 className="text-2xl font-medium tracking-tight mb-8">{relatedLabel}</h2>
